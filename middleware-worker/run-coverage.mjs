// Coverage runner with PER-MODULE threshold enforcement.
//
...
//
// Zero runtime deps (only node:child_process). Flags are passed as an argv
// array (shell:false), so the exclude globs are never touched by a shell —
// this avoids the Windows cmd.exe single-quote issue.
...
const MODULE_FLOORS = {
  "index.js": { line: 90, branch: 90 },
  "lexicon.js": { line: 90, branch: 90 },
  "llm.js": { line: 85, branch: 85 },
  "policy.js": { line: 90, branch: 90 },
  "sessions.js": { line: 90, branch: 90 },
  "session-object.js": { line: 90, branch: 90 },
};
...
// Parse the coverage table rows: "# index.js | 100.00 | 96.00 | 100.00 |".
